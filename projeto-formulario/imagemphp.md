# Imagem PHP- Descrição
Esta imagem configura uma aplicação web desenvolvida em PHP pronta para se conectar a um banco de dados MySQL. A aplicação possui um processo simplificado de levantamento de dados cadastrais, fluxo de dados este, que é tratado pelo MySQL. O usuário tem a permissão de inserir o nome, o CPF, um e-mail, uma senha, a data de nascimento e o estado civil, resultando em um registro tabelado. Por intermédio do Docker, virtualizei todas as etapas e com o Docker Compose gerenciei o processo.

## Componentes e Referências
- [Imagem da banco de dados MySQL](https://hub.docker.com/repository/docker/biancamalta/mysql-projetoformulario)
...
### Execução da imagem 
Nessa etapa iremos executar o container e passar algumas variáveis de ambiente. No quesito segurança, usar a configuração fornecida não é o ideal, recomendo personalizá-la. As variáveis são:
